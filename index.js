...
console.clear();
console.log(clc.blue("Emir"));
const setTitle = require('console-title');
setTitle("Developed By Em6r");

console.log(clc.red("Enter the module to run:"));
console.log(clc.red("1) AutoSniper"));
    ...
    case '1':
      ...
      bot.on('rawWS', async (packet) => {
        if (packet.t === "READY") {
          ...
          logMessage('Gateway', `Logged in as emirbaba`);
          ...
          const batchedData = Object.entries(Data).reduce((batches, [key, value]) => {
            console.log(`${clc.yellow.bold("Server Vanity : ")}  [${clc.blue.bold(value[0])}] || ${clc.yellow("Server Name :")} [${clc.blue.bold(guilds[value[1]].name)}] || ${clc.yellow("Server Id :")} [${clc.blue.bold(guilds[value[1]].id)}]`);
